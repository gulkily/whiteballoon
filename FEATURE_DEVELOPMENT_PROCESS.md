...
- Wait for explicit approval between steps (acknowledged by the user) before starting the next step; if approval is missing or ambiguous, ask for confirmation.
