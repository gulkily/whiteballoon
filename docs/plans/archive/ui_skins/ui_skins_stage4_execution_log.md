...
| 2025-11-14 | Paper Notebook skin bundle | `static/skins/paper.css`, `docs/skins/token_inventory.md` | `./wb skins build` | Another option ready for selector; consider serif font availability on all hosts. |
